 ...
 */
final class Version20190615100134 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE oauth_auth_codes (identifier VARCHAR(255) NOT NULL, expiry_date_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, user_identifier UUID NOT NULL, client VARCHAR(255) NOT NULL, scopes JSON NOT NULL, redirectUri VARCHAR(255) DEFAULT NULL, PRIMARY KEY(identifier))');
        $this->addSql('CREATE TABLE oauth_refresh_tokens (identifier VARCHAR(255) NOT NULL, access_token_identifier VARCHAR(80) NOT NULL, expiry_date_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(identifier))');
